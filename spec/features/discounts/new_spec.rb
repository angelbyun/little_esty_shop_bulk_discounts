...
RSpec.describe "discounts new" do
  ...
  describe "As a merchant when I visit the discounts new page" do
    it 'displays a form to add a new discount and all text fields must be filled in' do
      visit "/merchant/#{@merchant1.id}/discounts/new"

      click_button("Create Discount")

      expect(page).to have_content("Information Required!")

      fill_in(:item_quantity, with: 50)
